...
struct _rio {
     ...
     * and len fields pointing to the new block of data to add to the checksum computation. */
 ...
 * actual implementation of read / write / tell, and will update the checksum if needed. */
